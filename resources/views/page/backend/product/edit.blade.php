   ...
   <div class="modal-content">
      ...
      <div class="modal-header border-0 pb-0">
         <div class="form-header modal-header-title text-start mb-0">
            <h6 class="mb-0"  style="text-transform:uppercase">Update Product</h6>
         </div>
         <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
            <span class="align-center" aria-hidden="true">&times;</span>
         </button>
      </div>
      <form autocomplete="off" method="POST" action="{{ route('product.edit', ['unique_key' => $product_datas['unique_key']]) }}"  enctype="multipart/form-data">
      @csrf
         ...
         <div class="row">
               ...
               <div class="col-lg-12 col-md-12">
                  <div class="form-group">
                     ...
                     <textarea name="description" id="description" class="form-control" placeholder="Enter Description">{{$product_datas['description']}}</textarea>
                  </div>
               </div>
               <div class="col-lg-12 col-md-12">
                  <div class="form-group">
                     ...
                     <div style="display: flex">
                        <div><img src="{{ asset('assets/product_image/' . $product_datas['image']) }}" alt="" style="width: 150px !important; height: 150px !important; margin-right: 20px !important; "></div>
                      </div>
