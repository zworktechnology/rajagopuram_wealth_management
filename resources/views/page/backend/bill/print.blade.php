        ...
        <div class="tm_invoice_wrap">
            <div class="tm_invoice tm_style2" id="tm_download_section">
                <div class="tm_note tm_font_style_normal tm_text_center" style="margin-top: 0px">
                    <p><b class="tm_primary_color">Bill</b>
                </div>
                        ...
                        <div style="display: flex;">
                            <div style="width: 50%;">
                                <div style="border: 1px #e6e9f0; border-style: solid solid none none;">
                                    <p style="margin-bottom: 1px; padding: 10px;" class="tm_primary_color"><b>Bill
                                            No : </b> <span>#{{$BillData->billno}}</span></p>
                                </div>
                            </div>
                            <div style="width: 50%;">
                                <div style="border: 1px #e6e9f0; border-style: solid solid none none;">
                                    <p style="margin-bottom: 1px; padding: 10px;" class="tm_primary_color"><b>Date : </b><span>{{ date('d M Y', strtotime($BillData->date)) }}</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div style="border: 0.5px #e6e9f0;  border-style: solid solid solid none;">
                            <p style="margin-bottom: 1px; padding-right: 5px; padding-left: 5px;" class="tm_primary_color"><b>Buyer ( Bill to )</b></p>
                            ...
                            <table>
                                ...
                                @foreach ($productsdata as $index => $productsdata_arr)
                                    <tr class="tm_gray_bg">
                                        ...
                                        <td class="tm_width_1" style="border: 1px #e6e9f0; border-style: none solid solid none;">{{$productsdata_arr['bill_width']}}</td>
                                        <td class="tm_width_1" style="border: 1px #e6e9f0; border-style: none solid solid none;">{{$productsdata_arr['bill_height']}}</td>
                                        <td class="tm_width_1" style="border: 1px #e6e9f0; border-style: none solid solid none;">{{$productsdata_arr['bill_qty']}}</td>
                                        <td class="tm_width_1" style="border: 1px #e6e9f0; border-style: none solid solid none;">{{$productsdata_arr['bill_areapersqft']}}</td>
                                        <td class="tm_width_1" style="border: 1px #e6e9f0; border-style: none solid solid none;">{{$productsdata_arr['bill_rate']}}</td>
                                        <td class="tm_width_2 tm_text_right" style="border: 1px #e6e9f0; border-style: none solid solid none;">₹ {{$productsdata_arr['bill_product_total']}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                        ...
                        <div class="tm_right_footer">
                            <table class="tm_mb15">
                                <tbody>
                                    ...
                                    @if ($BillData->bill_tax_amount == 0)

                                    @else
                                    <tr>
                                        <td class="tm_width_3 tm_primary_color tm_border_none tm_pt0">GST {{$BillData->bill_tax_percentage}}%</td>
                                        <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_pt0">
                                        ₹ {{$BillData->bill_tax_amount}}</td>
                                    </tr>
                                    @endif
                                    @if ($BillData->bill_discount_price == 0)
