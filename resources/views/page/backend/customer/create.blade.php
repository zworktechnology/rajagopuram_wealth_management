                                            ...
                                            <div class="row align-item-center">
                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value=""  class="form-control" placeholder="Enter Customer Name" name="name"
                                                            id="name" required>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value=""  class="form-control" placeholder="Enter Phone No" name="phonenumber"
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value=""  class="form-control" placeholder="Enter Alter Phone No" name="alter_phonenumber"
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                    <div class="form-group">
                                                        <label>DOB</label>
                                                        <input type="date" value=""  class="form-control"  name="birth_date" id="birth_date" >
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                    <div class="form-group">
                                                        <label>Wedding Date</label>
                                                        <input type="date" value=""  class="form-control"  name="wedding_date" id="wedding_date" >
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value=""  class="form-control" placeholder="Enter E-Mail" name="email_id"
                                                            id="email_id" >
                                                    </div>
                                                </div>
                                                ...
                                                <tbody class="family_fields">
                                                    <tr>
                                                        ...
                                                        <input type="text" class="form-control family_name"
                                                                id="family_name" name="family_name[]" required value="" />
                                                        </td>
