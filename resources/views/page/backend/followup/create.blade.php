   ...
   <div class="modal-content">
      ...
      <div class="modal-header border-0 pb-0">
         <div class="form-header modal-header-title text-start mb-0">
            <h6 class="mb-0" style="text-transform:uppercase">Add Followup</h6>
         </div>
         ...
         <div class="row">
               ...
               <div class="col-lg-6 col-md-12" @if(Auth::user()->role == 'Admin') hidden   @endif>
                  <div class="form-group">
                     ...
                     <select class="form-control select  js-example-basic-single customeremployee_id" name="employee_id" id="employee_id" required>
